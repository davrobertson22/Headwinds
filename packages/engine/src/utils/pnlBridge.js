...
export function costBridge(proj, state = {}) {
  ...
  const farmFees     = n(r.totalFarmFeeIncome);    // rivals' throughput fees at farms you own (multiplayer)
  ...
  if (farmFees) push('farmFees', 'Fuel farm throughput fees', farmFees, 'income',
    'What rivals paid to fuel at farms you own — 3% of their uplift there, half from alliance partners.');
