// THROWAWAY PROBE (2026-08-31) — proof that tools/reassign-menu-anchor-test.mjs
// fails on HEAD bc24ef6, i.e. before the portal fix. It is the standing suite
// with its imports re-pointed at ./OldReassignRouteButton.jsx, which is
// `git show HEAD:src/components/ReassignRouteButton.jsx` with its relative
// imports rewritten for this folder. Expect 10 of 11 checks to fail. Untracked
...
// HEAD:src/components/ReassignRouteButton.jsx): 9 of 11 fail — no exported
...
const mod = await import('./OldReassignRouteButton.jsx');
