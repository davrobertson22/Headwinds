...
// The game logic — reducer, freshState, reconcileState — now lives in
// @tailwinds/engine (packages/engine/src/reducer.mjs), the single source of truth
// shared by the solo app and the multiplayer server. This file is just the React
// binding: the context provider, localStorage persistence, and the useGame hook.
// (Re-exported here so existing import sites that pull these from GameContext keep
// working.)
export { gameReducer, freshState, reconcileState };
