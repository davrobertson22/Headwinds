...
**Status:** Phases 1a + 1b + 4 + 5 + 2 BUILT (2026-09-05; Phase 2 on disk, uncommitted, both repos). Decision 3 (GATEWAY_RESIDUAL) awaits Dave; Phase 3 next.
...
**Phase 2 — interline feed from real rival legs, BUILT 2026-09-05 (both repos, on disk).**
